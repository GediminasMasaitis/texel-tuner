...
const i32 material[] = { S(67, 83), S(271, 402), S(276, 399), S(360, 714), S(789, 1345), 0 };
const i32 pst_rank[] = { 0, S(-11, -5), S(-16, -8), S(-8, -7), S(6, 0), S(29, 19), S(95, 100), 0, // Pawn
S(-23, -38), S(-13, -22), S(1, -6), S(14, 20), S(25, 27), S(45, 10), S(26, 3), S(-76, 6), // Knight
S(-9, -14), S(6, -13), S(12, -3), S(13, 2), S(14, 7), S(16, 5), S(-1, 5), S(-52, 12), // Bishop
S(3, -22), S(-9, -23), S(-13, -15), S(-16, 4), S(2, 14), S(17, 13), S(5, 21), S(10, 8), // Rook
S(13, -63), S(15, -49), S(8, -20), S(-3, 13), S(-7, 34), S(-1, 31), S(-19, 37), S(-7, 17), // Queen
S(-8, -47), S(-4, -6), S(-32, 9), S(-37, 24), S(-2, 35), S(53, 32), S(62, 16), S(60, -47), // King
};
const i32 pst_file[] = { S(-17, 11), S(-13, 11), S(-9, 0), S(-1, -10), S(5, -3), S(20, -2), S(20, -1), S(-5, -6), // Pawn
S(-26, -22), S(-11, -4), S(1, 10), S(14, 19), S(12, 18), S(11, 5), S(3, -3), S(-5, -22), // Knight
S(-11, -8), S(2, -1), S(5, 1), S(2, 7), S(5, 8), S(-3, 4), S(6, -1), S(-4, -9), // Bishop
S(-8, 2), S(-7, 5), S(0, 6), S(9, -2), S(13, -6), S(2, 2), S(0, -1), S(-9, -6), // Rook
S(-10, -23), S(-7, -6), S(-1, 3), S(2, 9), S(3, 14), S(0, 15), S(7, -1), S(6, -10), // Queen
S(-16, -29), S(24, 0), S(-4, 16), S(-50, 31), S(-20, 23), S(-40, 23), S(21, -1), S(2, -39), // King
};
const i32 mobilities[] = { 0, S(6, 3), S(6, 5), S(2, 4), S(3, 1), S(-9, -3) };
const i32 king_attacks[] = { 0, 0, S(15, -3), S(19, -7), S(14, 8), 0 };
const i32 open_files[] = { S(11, 22), S(-8, 0), S(-9, 12), S(17, 6), S(-1, 22), S(-25, 15), S(12, 25), S(-13, -9), S(-13, 2), S(31, 12), S(-14, 42), S(-59, 9) };
const i32 passed_pawns[] = { S(-7, 10), S(-10, 16), S(-7, 41), S(11, 67), S(34, 114), S(95, 100) };
const i32 passed_blocked_pawns[] = { S(1, -11), S(-4, -9), S(3, -34), S(13, -65), S(15, -115), S(-37, -120) };
const i32 protected_pawn = S(17, 16);
const i32 phalanx_pawn = S(11, 14);
const i32 bishop_pair = S(24, 62);
